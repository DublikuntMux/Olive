...
/**
 * @brief Blend a rectangular area of the sprite onto the canvas. This is useful
 * for drawing things that are part of a sprite such as textures or text - to -
 * be - drawn in an OpenLivec - compatible way.
...
/**
 * @brief Copy a rectangular area of the sprite onto the canvas. This is useful
 * for copying an image to a different location in the same rendering context.
 * @param oc The canvas to copy onto. Must have Olivec_Canvas :: type ==
 * OLVEC_SPRITE
...
/**
 * @brief Return a pixel value from a rectangular area. The rectangle is divided
 * equally into w and h parts and the result is clipped to the range [ 0 1 ]
 ...
 * @param w The width of the rectangle. This is the number of pixels that will
 * be drawn in the sprite.
 * @param h The height of the rectangle. This is the number of pixels that will
 * be drawn in the sprite.
 * @return The pixel value in the form of a uint32_t value which can be used as
 * a color
 */
...
/**
 * @brief Copy a bilinear part of the sprite. This is a convenience function for
 * copying an image to a canvas without using a pre - allocated buffer.
