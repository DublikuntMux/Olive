...
void generate_c_code_from_pixels(FILE *out, uint32_t *data, int x, int y,
                                 const char *name) {
...
bool generate_c_file_from_png(const char *input_file_path,
...
int main(int argc, char *argv[]) {
  ...
  if (!generate_c_file_from_png(input_file_path, output_file_path, name))
    return 1;
